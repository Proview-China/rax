...
const schemaV5 = `
CREATE TABLE IF NOT EXISTS governed_model_turn_v3_provider_boundary_history (
...
CREATE INDEX IF NOT EXISTS governed_model_turn_v3_provider_boundary_history_exact
  ON governed_model_turn_v3_provider_boundary_history(
    boundary_id,
    revision,
    fact_digest,
    ref_digest,
    ...
    provider_attempt_ordinal,
    attempt_request_digest,
    provider_binding_set_id,
    provider_binding_set_revision,
