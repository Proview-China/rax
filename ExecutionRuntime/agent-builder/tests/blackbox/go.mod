module github.com/Proview-China/rax/ExecutionRuntime/agent-assembler/agent-builder-blackbox
...
replace github.com/Proview-China/rax/ExecutionRuntime/agent-builder => ../..
