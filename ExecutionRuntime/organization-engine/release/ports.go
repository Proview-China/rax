...
type LocalReadinessReaderV1 interface {
	InspectOrganizationLocalReadinessV1(context.Context, string, core.Revision) (LocalReadinessProjectionV1, error)
}

type ProductionReadinessReaderV1 interface {
	InspectOrganizationProductionReadinessV1(context.Context, string, core.Revision) (ProductionReadinessProjectionV1, error)
}
