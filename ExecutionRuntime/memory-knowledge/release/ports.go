...
type LocalReadinessReaderV1 interface {
	InspectMemoryKnowledgeLocalReadinessV1(context.Context, string, core.Revision) (LocalReadinessProjectionV1, error)
}
type ProductionReadinessReaderV1 interface {
	InspectMemoryKnowledgeProductionReadinessV1(context.Context, string, core.Revision) (ProductionReadinessProjectionV1, error)
}
