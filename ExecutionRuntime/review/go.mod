module github.com/Proview-China/rax/ExecutionRuntime/review

go 1.25.0

require (
	github.com/Proview-China/rax/ExecutionRuntime/agent-assembler v0.0.0
	github.com/Proview-China/rax/ExecutionRuntime/agent-host v0.0.0
	github.com/Proview-China/rax/ExecutionRuntime/application v0.0.0
	github.com/Proview-China/rax/ExecutionRuntime/continuity v0.0.0
	...
	github.com/Proview-China/rax/ExecutionRuntime/organization-engine v0.0.0
...
replace github.com/Proview-China/rax/ExecutionRuntime/agent-host => ../agent-host
...
replace github.com/Proview-China/rax/ExecutionRuntime/organization-engine => ../organization-engine
