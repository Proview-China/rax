...
func TestMCPResourcePromptDiscoveryMaterialReadAPIV1(t *testing.T) {
	source := newAPIMCPResourcePromptMaterialSourceV1()
	resources, err := api.NewMCPResourceDiscoveryMaterialReadV1(source)
	if err != nil {
		t.Fatal(err)
	}
	prompts, err := api.NewMCPPromptDiscoveryMaterialReadV1(source)
	if err != nil {
		t.Fatal(err)
	}
	resourceSets, err := api.NewMCPDiscoveryPageResourceMaterialSetReadV1(source)
	if err != nil {
		t.Fatal(err)
	}
	promptSets, err := api.NewMCPDiscoveryPagePromptMaterialSetReadV1(source)
	if err != nil {
		t.Fatal(err)
	}
...
func TestMCPResourcePromptDiscoveryMaterialReadAPIV1FailsClosed(t *testing.T) {
	var typedNil *apiMCPResourcePromptMaterialSourceV1
	if _, err := api.NewMCPResourceDiscoveryMaterialReadV1(typedNil); !core.HasReason(err, core.ReasonComponentMissing) {
		t.Fatalf("typed-nil Resource constructor error=%v", err)
	}
	if _, err := api.NewMCPPromptDiscoveryMaterialReadV1(typedNil); !core.HasReason(err, core.ReasonComponentMissing) {
		t.Fatalf("typed-nil Prompt constructor error=%v", err)
	}
	if _, err := api.NewMCPDiscoveryPageResourceMaterialSetReadV1(typedNil); !core.HasReason(err, core.ReasonComponentMissing) {
		t.Fatalf("typed-nil Resource set constructor error=%v", err)
	}
	if _, err := api.NewMCPDiscoveryPagePromptMaterialSetReadV1(typedNil); !core.HasReason(err, core.ReasonComponentMissing) {
		t.Fatalf("typed-nil Prompt set constructor error=%v", err)
	}
	source := newAPIMCPResourcePromptMaterialSourceV1()
	resources, _ := api.NewMCPResourceDiscoveryMaterialReadV1(source)
	prompts, _ := api.NewMCPPromptDiscoveryMaterialReadV1(source)
...
type apiMCPResourcePromptMaterialSourceV1 struct {
...
func newAPIMCPResourcePromptMaterialSourceV1() *apiMCPResourcePromptMaterialSourceV1 {
	return &apiMCPResourcePromptMaterialSourceV1{resource: testkit.MCPResourceDiscoveryMaterialV1(), prompt: testkit.MCPPromptDiscoveryMaterialV1(), resourceSet: testkit.MCPDiscoveryPageResourceMaterialSetV1(), promptSet: testkit.MCPDiscoveryPagePromptMaterialSetV1()}
}

func (s *apiMCPResourcePromptMaterialSourceV1) InspectExactMCPResourceDiscoveryMaterialV1(context.Context, toolcontract.MCPResourceDiscoveryMaterialRefV1) (toolcontract.MCPResourceDiscoveryMaterialV1, error) {
...
func (s *apiMCPResourcePromptMaterialSourceV1) InspectExactMCPPromptDiscoveryMaterialV1(context.Context, toolcontract.MCPPromptDiscoveryMaterialRefV1) (toolcontract.MCPPromptDiscoveryMaterialV1, error) {
...
func (s *apiMCPResourcePromptMaterialSourceV1) InspectMCPDiscoveryPageResourceMaterialSetV1(context.Context, toolcontract.ObjectRef) (toolcontract.MCPDiscoveryPageResourceMaterialSetV1, error) {
	return toolcontract.CloneMCPDiscoveryPageResourceMaterialSetV1(s.resourceSet), nil
}

func (s *apiMCPResourcePromptMaterialSourceV1) InspectMCPDiscoveryPagePromptMaterialSetV1(context.Context, toolcontract.ObjectRef) (toolcontract.MCPDiscoveryPagePromptMaterialSetV1, error) {
