...
公共输出 `AgentPackageRefV1` 可作为后续 Host 合同的 exact 输入；lock 可追溯 Definition、Facts、Catalog、Releases、Plan、Binding、Assembly 与 Generation/Manifest/Graph/Handoff。当前不包含加载仓、生命周期、运行面或生产资格。
