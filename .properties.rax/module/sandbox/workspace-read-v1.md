...
| SQLite | ExecutionRuntime/sandbox/storage/sqlite/workspace_read_v1.go | Durable origin/current, pure Inspect, explicit incarnation recovery, TTL write gates, concurrency |
